          ...
          <div class="row">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="idNombre" name="nuevoNombre" placeholder="Ingresar nombre" 
                 maxlength="50"  pattern="[A-Za-z0-9 ]+" title="Solo se acepta letras y números" required>
            </div>
            </div>
          ...
          <!-- ENTRADA PARA EL DESCRIPCIÓN -->
           ...
           <div class="form-group">
            <div class="input-group">
                ...
                maxlength="100" pattern="[A-Za-z0-9 ]+" title="Solo se acepta letras y números" required>
            </div>
           </div>
