...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Administrador de Costos de Marketing</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Costos de Marketing</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <?php 
       ...
       echo "<button class='btn btn-primary' data-toggle='modal' data-target='#modalAgregarCostoMarketing'>
            Agregar Costo de Marketing
            </button>";

       }else{

       echo "<button class='btn btn-primary'>Agregar Costo de Marketing</button>";
      ...
      <table class="table table-bordered table-striped dt-responsive tablaCostoMarketing" width="100%">
...
<div id="modalAgregarCostoMarketing" class="modal fade" role="dialog">
...
<div class="modal-dialog modal-lg">
  ...
  <div class="modal-content">
    ...
    <form role="form" method="post" enctype="multipart/form-data">
      ...
      <h4 class="modal-title">Agregar Costo de Marketing</h4>
      ...
      <?php
          ...
          $crearCostoMarketing= new ControladorCostoMarketing();
          $crearCostoMarketing -> ctrCrearCostoMarketing();
...
<div class="modal-dialog modal-lg">
  ...
  <div class="modal-content">
    ...
    <form role="form" method="post" enctype="multipart/form-data">
      ...
      <h4 class="modal-title">Editar Costo de Marketing</h4>
      ...
      <div class="box-body">
        ...
        <label for="descripcion">Descripción</label>
          <div class="input-group">
              ...
              maxlength="100" pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚ ]+" title="Solo se acepta letras y números" required>
              <input type="hidden" id="idCostoMarketing" name="idCostoMarketing">
          </div>
        </div>
      ...
      <?php
          ...
          $editarCostoMarketing = new ControladorCostoMarketing();
          $editarCostoMarketing -> ctrEditarCostoMarketing();
...
<?php
  ...
  $borrarCostoMarketing = new ControladorCostoMarketing();
  $borrarCostoMarketing -> ctrEliminarCostoMarketing();
