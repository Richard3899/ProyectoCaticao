  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <?php 
       ...
       echo "<button class='btn btn-primary' data-toggle='modal' data-target='#modalAgregarCostoOperativo'>
            Agregar Costo Operativo
            </button>";

       }else{

       echo "<button class='btn btn-primary'>Agregar Costo Operativo</button>";
