...
$('.tablaRecetaCostoVenta').DataTable( {
	"ajax": "ajax/datatable-recetacostoventa.ajax.php?idRecetaC="+idRecetaC+"&permisoEditar="+permisoEditar+"&permisoEliminar="+permisoEliminar,
    "deferRender": true,
	"columnDefs": [
...
function sumaTotalPrecioRecetaCostoVenta(){
	...
	var sumaTotalPrecioUnitario = arraySumaPrecioUnitario.reduce(sumaArrayPrecioUnitario,0);
		...
		$(".precioCostoVenta").val(sumaTotalPrecioUnitario.toFixed(2));
...
function editarsumaTotalPrecioRecetaCostoVenta(){
	...
	var sumaTotalPrecioUnitario = arraySumaPrecioUnitario.reduce(sumaArrayPrecioUnitario,0);
		...
		$(".editarPrecioCostoVenta").val(sumaTotalPrecioUnitario.toFixed(2));
