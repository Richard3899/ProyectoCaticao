...
INSERT INTO `costorecetasgastoadmin` VALUES (1,'DICIEMBRE DEL 2022','2023-02-01');
...
INSERT INTO `empleado` VALUES (1,'Julio','Gonzales','Av. Alfonso Ugarte Lt.12','987654321','julio@gmail.com','432187654','2023-03-10','Empaquetador','8am - 6pm',8,80.00,10.00,1000.00,1,NULL,1);
...
INSERT INTO `gastoadminpormes` VALUES (4,'Gasto Administrativo 1',5.00,70.00,350.00,1,1);
...
INSERT INTO `inventariomateria` VALUES (1,249.99,1),(2,0.00,2),(3,50.00,3),(4,-5.00,4),(5,100.00,5),(6,2000.00,6);
...
INSERT INTO `inventarioproducto` VALUES (1,99.00,1);
...
INSERT INTO `lote` VALUES (1,'123456','2023-01-01',0.00,1),(2,'767','2023-03-02',99.00,1),(3,'123','2023-03-10',0.00,1);
...
INSERT INTO `movimientomateria` VALUES (1,250.00,0.00,'Produccion','2022-12-17','S-C','2022-12-11 15:23:25',1,1),(2,150.00,0.00,'Produccion','2022-12-31','S-C','2022-12-11 15:23:37',4,1),(3,100.00,0.00,'Produccion','2022-12-10','S-C','2022-12-11 15:23:50',3,1),(4,500.00,0.00,'Produccion','2022-12-17','S-C','2022-12-11 15:24:33',5,1),(5,200.00,0.00,'Produccion','2023-01-26','S-C','2023-01-08 07:08:42',2,1),(6,2000.00,0.00,'Produccion','2023-01-10','S-C','2023-01-08 07:08:52',6,1),(9,0.00,50.00,'Agregado Receta:','2023-03-17','RC001','2023-03-18 00:36:13',3,2),(10,0.00,150.00,'Retiro','2023-03-18','S-C','2023-03-18 00:37:43',4,2),(13,0.00,400.00,'Agregado Receta:','2023-03-17','RC001','2023-03-18 00:49:25',5,2),(16,0.00,0.01,'Agregado Receta:','2023-03-17','RC001','2023-03-18 02:16:40',1,2),(17,0.00,200.00,'1','2023-03-02','S-C','2023-03-18 02:21:13',2,2),(18,0.00,5.00,'Retiro','2023-03-16','S-C','2023-03-18 02:26:51',4,2);
...
INSERT INTO `movimientoproducto` VALUES (1,100.00,0.00,'Compra','2023-03-03','2023-03-18 02:27:43',2,1),(2,0.00,1.00,'Retiro','2023-03-09','2023-03-18 02:28:29',2,2),(3,1.00,0.00,'Compra','2023-03-01','2023-03-18 22:29:33',3,1),(4,0.00,1.00,'Retiro','2023-03-18','2023-03-18 22:30:06',3,2);
...
INSERT INTO `receta` VALUES (1,'RC001','Receta 1',60.00,'2023-01-01','2023-01-01',1.00,1.00,1.00,1.00,'123456',0,5,173.52,34.70,1);
...
INSERT INTO `recetaconsumoenergia` VALUES (2,'Seleccionadora',0.75,5.70,4.28,0.72,3.08,1,1,1);
...
INSERT INTO `recetaconsumogas` VALUES (1,'Seleccionadora',1.00,1.30,1.30,1.69,1,1);
...
INSERT INTO `recetacostomarketing` VALUES (2,'Costo de Marketing 1',0.10,10.00,1.00,3,1);
...
INSERT INTO `recetacostooperativo` VALUES (2,'Costo Operativo 1',0.10,12.00,1.20,4,1);
...
INSERT INTO `recetacostoventa` VALUES (3,'Costo de Venta 1',0.10,15.00,1.50,2,1);
...
INSERT INTO `recetadepreciacion` VALUES (1,'Seleccionadora',0.22,9.10,2.00,1,1);
...
INSERT INTO `recetamanodeobra` VALUES (1,'Julio Gonzales','Seleccionadora',6.90,10.00,69.00,1,1,1);
...
INSERT INTO `recetamateria` VALUES (1,'AGUA - SAFE',50.00,1.00,50.00,3,1),(2,'CACAO - SAFE',400.00,0.11,44.00,5,1),(4,'LECHE - GLORIA',0.01,4.58,0.05,1,1);
...
INSERT INTO `usuario` VALUES (1,'Administrador','admin','$2a$07$asxx54ahjppf45sd87a5aunxs9bkpyGmGE/.vekdjFg83yRec789S','vistas/img/usuarios/admin/211.png',1,'2023-03-19 21:48:50','2022-10-18 21:42:18',1);
...
-- Dump completed on 2023-03-20 14:00:27
